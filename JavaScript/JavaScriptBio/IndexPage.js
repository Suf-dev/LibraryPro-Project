...
function getBook(){
    document.querySelector("form.input").addEventListener("submit",function(e) {
        ...
        fetch(`http://localhost:9001/displayid/${bookid}`, {
            method: "GET",
            mode: "cors",
            headers: {
    ...
    .then(function (data) {
            ...
            bname.className = "alert alert-dark col-md-8";
            bname.innerText= `Title : ${(bname.innerHTML= data.bname)}`;
